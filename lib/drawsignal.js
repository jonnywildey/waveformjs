...
module.exports = {
	...
	createJson: function (size, title, path, totalTurns) {
		...
		var json = {
			...
			playbackStartMagnitude: size - me.calculatePlaybackStartMagnitude(size), //distance from origin
	...
	calculatePlaybackStartMagnitude: function (size) {
		var me = this;
		var gapAmplification = (1 - me.gap) * 0.5;
		var hSize = size * 0.5;
		var mag = ((hSize - (hSize * me.innerLabelSize)) / 3)
			* gapAmplification;
		return mag;
	},
