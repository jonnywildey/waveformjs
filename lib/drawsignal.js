...
module.exports = {
	...
	createJson: function (size, title, path, totalTurns) {
      ...
      playbackDistance: me.calculatePlaybackDistance(size, totalTurns),
	...
	calculateInnerLabelRadius: function (size, totalTurns) {
		...
		innerRadius -= ((outerRadius - (outerRadius * me.innerLabelSize)) / 3)
		* gapAmplification;
		return innerRadius;
	},
  ...
  calculatePlaybackDistance: function (size, totalTurns) {
    var outerRadius = size * 0.5;
    var gapAmplification = (1 - this.gap) * 0.5;
    //reduce outer radius to account for maximum amplification
    outerRadius -= ((outerRadius - (outerRadius * this.innerLabelSize)) / totalTurns)
    * gapAmplification;
    var innerRadius = outerRadius * this.innerLabelSize; //roughly 45rpm record dimensions
